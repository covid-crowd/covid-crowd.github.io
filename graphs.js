...
function drawGraph(values) {    
  ...
  function get_question_string(plural_entity_name, closed, closed_date, closed_url, open, open_date, open_url) {
    if (closed != "Yes")
    {
      ...
      if (closed_date)
      {
        question_string += " on " + moment(closed_date).format("dddd, MMMM D Y") + ".";
      }
      else {
    ...
    if (open == "Yes") {
      ...
      if (open_date)
      {
        question_string += " on " + moment(open_date).format("dddd, MMMM D Y") + ".";
      }
      else {
         question_string += ", no date provided."
      }
  ...
  function get_religion_string(county) {
    ...
    if (data.religion_closed != "Yes")
    {
      ...
      {
        question_string += " on " + moment(data.religion_closed_date).format("dddd, MMMM D Y") + ".";
      }
      else {
         question_string += ", no date provided."
      }
    ...
    if (data.religion_open == "Yes") {
      ...
      {
        question_string += " on " + moment(data.religion_open_date).format("dddd, MMMM D Y") + ".";
      }
      else {
         question_string += ", no date provided."
      }
  ...
  function get_lockdown_string(county) {
    ...
    if (data.lockdown_closed != "Yes")
    {
      ...
      {
        question_string += " on " + moment(data.lockdown_closed_date).format("dddd, MMMM D Y") + ".";
      }
      else {
         question_string += ", no date provided."
      }
    ...
    if (data.lockdown_open == "Yes") {
      ...
      {
        question_string += " on " + moment(data.lockdown_open_date).format("dddd, MMMM D Y") + ".";
      }
      else {
         question_string += ", no date provided."
      }
